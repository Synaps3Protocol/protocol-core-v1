...
interface IRightsPolicyAuthorizer {
    ...
    /// @param holder The address of the asset rights holder to verify authorization.
    function isPolicyAuthorized(address policy, address holder) external view returns (bool);

    /// @notice Authorizes a policy contract, granting it rights to manage the asset associated with the holder.
    ...
    /// @dev This function removes the rights of a policy, preventing it from managing the asset holder’s assets.
